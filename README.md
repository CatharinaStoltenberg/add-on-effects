...
to several national databases: the [Norwegian Prescription Database](https://www.norpd.no/), the [Cause of Death Registry](https://www.fhi.no/en/ch/cause-of-death-registry/), the [https://helsedata.no/en/forvaltere/norwegian-institute-of-public-health/norwegian-patient-registry-npr/](Norwegian Patient Registry), and [Statistics Norway](https://www.ssb.no/en). 
